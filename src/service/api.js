...
export const loginService = (params,isLoading) => postData('/api/v1/idc/account/login', params,isLoading);   //登录
export const logoutService = (params,isLoading) => postData('/api/v1/idc/account/logout', params,isLoading);   //退出登录
export const registerService = (params,isLoading) => postData('/api/v1/idc/account/register', params,isLoading);   //注册
